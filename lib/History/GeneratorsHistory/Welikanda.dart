...
class Aralaganvilaw extends StatefulWidget {
  const Aralaganvilaw({Key? key}) : super(key: key);

  @override
  _AralaganvilawState createState() => _AralaganvilawState();
}

class _AralaganvilawState extends State<Aralaganvilaw> {
...
// database eka ha sambandawimata adalawa mention krnne
  final Stream<QuerySnapshot> _polonnaruwaStream = FirebaseFirestore.instance
      ...
      .orderBy('last_repaired_date_rw', descending: true)
      .snapshots();
                ...
                children: [
                  ...
                  ListView(
                      ...
                      children:
                        ...
                        String rsu = document['name_of_repairing_generator_rw'];

                        String changes =
                            document['any_other_changes_identified_rw']
                                .toString();

                        String description =
                            document['description_rw'].toString();
                        String replace =
                            document['need_to_replace_rw'].toString();
                        String reason = document['reason_rw'].toString();

                        Timestamp last = document[
                            'last_repaired_date_rw']; // Timestamp(seconds=1624653319,nanoseconds=326000000)
