...
class Aralaganvilapu extends StatefulWidget {
  const Aralaganvilapu({Key? key}) : super(key: key);

  @override
  _AralaganvilapuState createState() => _AralaganvilapuState();
}

class _AralaganvilapuState extends State<Aralaganvilapu> {
...
// database eka ha sambandawimata adalawa mention krnne
  final Stream<QuerySnapshot> _polonnaruwaStream = FirebaseFirestore.instance
      ...
      .orderBy('last_repaired_date_rpu', descending: true)
      .snapshots();
                ...
                children: [
                  ...
                  ListView(
                      ...
                      children:
                        ...
                        String rsu =
                            document['name_of_repairing_generator_rpu'];

                        String changes =
                            document['any_other_changes_identified_rpu']
                                .toString();

                        String description =
                            document['description_rpu'].toString();
                        String replace =
                            document['need_to_replace_rpu'].toString();
                        String reason = document['reason_rpu'].toString();

                        Timestamp last = document[
                            'last_repaired_date_rpu']; // Timestamp(seconds=1624653319,nanoseconds=326000000)
