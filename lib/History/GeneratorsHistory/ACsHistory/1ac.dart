...
class Ac1 extends StatefulWidget {
  const Ac1({Key? key}) : super(key: key);
...
/*
            ...
            return ListView(
                ...
                children: snapshot.data!.docs.map((DocumentSnapshot document) {
                  ...
                  Timestamp last = document[
                      'last_repaired_date']; // Timestamp(seconds=1624653319,nanoseconds=326000000)
                  DateTime lastdate = last.toDate();
                  Timestamp next = document['next_repairing_date'];
                    ...
                    children: [
                      Container(
                        ...
                        child: buildCard(
                            ...
                            id,
                            coolingsufficient,
                            indoorplantcondition,
                            outdoorplantcondition,
                            remarkorcomments,
                            lastdate,
                            nextdate),
                      ),
  ...
  Widget buildCard(rsu, id, coolingsufficient, indoorplantcondition,
          outdoorplantcondition, remarkorcomments, lastdate, nextdate) =>
  ...
  Widget _dataRetrieve(rsu, id, coolingsufficient, indoorplantcondition,
      outdoorplantcondition, remarkorcomments, nextdate) {
    return ListView(
      shrinkWrap: true,
      children: [
        const SizedBox(
        ...
        Text(
          "Outdoor Plant Condition  :   " + outdoorplantcondition,
        ...
        Text(
          "Indoor Plant Condition  :   " + indoorplantcondition,
          style: const TextStyle(
              // backgroundColor: Colors.white10,
        ...
        Text(
          "Remark or Comments   :  " + remarkorcomments,
          style: const TextStyle(color: Color.fromARGB(169, 0, 0, 0)),
          textScaleFactor: 1,
        ),
        const SizedBox(
