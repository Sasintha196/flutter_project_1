...
class Aralaganvilah extends StatefulWidget {
  const Aralaganvilah({Key? key}) : super(key: key);

  @override
  _AralaganvilahState createState() => _AralaganvilahState();
}

class _AralaganvilahState extends State<Aralaganvilah> {
...
// database eka ha sambandawimata adalawa mention krnne
  final Stream<QuerySnapshot> _polonnaruwaStream = FirebaseFirestore.instance
      ...
      .orderBy('last_repaired_date_rh', descending: true)
      .snapshots();
                ...
                children: [
                  ...
                  ListView(
                      ...
                      children:
                        ...
                        String rsu = document['name_of_repairing_generator_rh'];

                        String changes =
                            document['any_other_changes_identified_rh']
                                .toString();

                        String description =
                            document['description_rh'].toString();
                        String replace =
                            document['need_to_replace_rh'].toString();
                        String reason = document['reason_rh'].toString();

                        Timestamp last = document[
                            'last_repaired_date_rh']; // Timestamp(seconds=1624653319,nanoseconds=326000000)
