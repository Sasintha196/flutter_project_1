...
class Aralaganvilam extends StatefulWidget {
  const Aralaganvilam({Key? key}) : super(key: key);

  @override
  _AralaganvilamState createState() => _AralaganvilamState();
}

class _AralaganvilamState extends State<Aralaganvilam> {
...
// database eka ha sambandawimata adalawa mention krnne
  final Stream<QuerySnapshot> _polonnaruwaStream = FirebaseFirestore.instance
      ...
      .orderBy('last_repaired_date_rm', descending: true)
      .snapshots();
                ...
                children: [
                  ...
                  ListView(
                      ...
                      children:
                        ...
                        String rsu = document['name_of_repairing_generator_rm'];

                        String changes =
                            document['any_other_changes_identified_rm']
                                .toString();

                        String description =
                            document['description_rm'].toString();
                        String replace =
                            document['need_to_replace_rm'].toString();
                        String reason = document['reason_rm'].toString();

                        Timestamp last = document[
                            'last_repaired_date_rm']; // Timestamp(seconds=1624653319,nanoseconds=326000000)
