...
class Aralaganvilap extends StatefulWidget {
  const Aralaganvilap({Key? key}) : super(key: key);

  @override
  _AralaganvilapState createState() => _AralaganvilapState();
}

class _AralaganvilapState extends State<Aralaganvilap> {
...
// database eka ha sambandawimata adalawa mention krnne
  final Stream<QuerySnapshot> _polonnaruwaStream = FirebaseFirestore.instance
      ...
      .orderBy('last_repaired_date_rp', descending: true)
      .snapshots();
                ...
                children: [
                  ...
                  ListView(
                      ...
                      children:
                        ...
                        String rsu = document['name_of_repairing_generator_rp'];

                        String changes =
                            document['any_other_changes_identified_rp']
                                .toString();

                        String description =
                            document['description_rp'].toString();
                        String replace =
                            document['need_to_replace_rp'].toString();
                        String reason = document['reason_rp'].toString();

                        Timestamp last = document[
                            'last_repaired_date_rp']; // Timestamp(seconds=1624653319,nanoseconds=326000000)
